...
class MIXIM_API CustomAppLayer : public MyTestAppLayer
{
    private:
        ...
        //Se帽al para emitir cuando se recibe un paquete del l抎er
        simsignal_t leaderInfoSignal;

        //Se帽al para emitir cuando se recibe un paquete DIRECTAMENTE del l抎er
        simsignal_t leaderInfoDirectSignal;

        //Se帽al para emitir cuando se recibe un paquete del l抎er por MULTISALTO
        simsignal_t leaderInfoMultihopSignal;

        //Se帽al para emitir cuando se USA un paquete del l抎er por MULTISALTO
